...
#' @returns It returns as output a generic text according to certain conditions which are as follows:
...
interp_continuous_2g <- function(data, groupvar, contvar) {
  ...
  if (length(levels(data[[groupvar]])) != 2) {
    stop("La variable de agrupacion debe tener exactamente dos niveles.")
  }
